...
export class IndentSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl).setName("Content under H1").addText((number) =>
			number
				.setPlaceholder("")
		...
		new Setting(containerEl).setName("Content under H2").addText((text) =>
			text
				.setPlaceholder("")
		...
		new Setting(containerEl).setName("Content under H3").addText((text) =>
			text
				.setPlaceholder("")
		...
		new Setting(containerEl).setName("Content under H4").addText((text) =>
			text
				.setPlaceholder("")
		...
		new Setting(containerEl).setName("Content under H5").addText((text) =>
			text
				.setPlaceholder("")
		...
		new Setting(containerEl).setName("Content under H6").addText((text) =>
			text
				.setPlaceholder("")
